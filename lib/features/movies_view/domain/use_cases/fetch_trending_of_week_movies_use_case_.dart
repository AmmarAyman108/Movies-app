...
class FetchTrendingOfWeekMoviesUseCase extends UseCase<List<MovieEntity>> {
  final MoviesRepo moviesRepo;

  FetchTrendingOfWeekMoviesUseCase({required this.moviesRepo});
  @override
  Future<Either<Failure, List<MovieEntity>>> call() async {
    return await moviesRepo.fetchTrendingOfWeekMovies();
  }
}
